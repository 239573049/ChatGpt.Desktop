...
{
    /// <summary>
    /// Scan the local folders from the repo, looking for "chatgpt/skills" folder.
    /// </summary>
    /// <returns>The full path to chatgpt/skills</returns>
    internal static string ChatgptSkillsPath()
    {
        const string PARENT = "chatgpt";
